import{_ as e,M as t,p as o,q as c,Q as n,t as a,N as p,a1 as r}from"./framework-7b83bea1.js";const l={},i=r(`<h1 id="docker-快速部署前端" tabindex="-1"><a class="header-anchor" href="#docker-快速部署前端" aria-hidden="true">#</a> Docker 快速部署前端</h1><p>为了快速演示，我们可以使用 Docker 快速部署一个前端项目。</p><p>首先我们需要在前端项目添加一个 <code>Dockerfile</code> 文件，内容如下：</p><div class="language-docker" data-ext="docker"><pre class="language-docker"><code><span class="token instruction"><span class="token keyword">FROM</span> nginx:1.23.3-alpine</span>
