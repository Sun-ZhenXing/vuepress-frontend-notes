...
<span class="token instruction"><span class="token keyword">CMD</span> [<span class="token string">&quot;nginx&quot;</span>, <span class="token string">&quot;-g&quot;</span>, <span class="token string">&quot;daemon off;&quot;</span>]</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>你可以克隆本项目，即上放的 GitHub 地址，本项目提供了上述 <code>Dockerfile</code> 文件，你可以构建镜像：</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token function">docker</span> build <span class="token parameter variable">-t</span> my_docs:v1 <span class="token builtin class-name">.</span>
</code></pre></div><p>构建成功后运行容器：</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token function">docker</span> run <span class="token parameter variable">-itd</span> <span class="token parameter variable">-p</span> <span class="token number">80</span>:80 my_docs:v1
</code></pre></div>`,11),g={href:"http://localhost/",target:"_blank",rel:"noopener noreferrer"},b={href:"http://localhost/vuepress-frontend-notes/",target:"_blank",rel:"noopener noreferrer"};function _(f,x){const t=o("router-link"),e=o("ExternalLinkIcon");return i(),r("div",null,[u,s("nav",k,[s("ul",null,[s("li",null,[a(t,{to:"#_1-nginx-快速演示"},{default:c(()=>[n("1. Nginx 快速演示")]),_:1})]),s("li",null,[a(t,{to:"#_2-编译并部署"},{default:c(()=>[n("2. 编译并部署")]),_:1})])])]),v,s("p",null,[n("打开 "),s("a",m,[n("http://localhost/"),a(e)]),n(" 即可看到内容。")]),h,s("p",null,[n("打开 "),s("a",g,[n("http://localhost/"),a(e)]),n(" 即可看到被重定向到 "),s("a",b,[n("http://localhost/vuepress-frontend-notes/"),a(e)]),n("，可以找到本页面的内容。")])])}const w=l(d,[["render",_],["__file","docker.html.vue"]]);export{w as default};
