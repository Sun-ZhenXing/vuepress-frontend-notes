import{_ as l,M as c,p as i,q as u,Q as n,N as a,V as o,t as s,a1 as t}from"./framework-d2b9082c.js";const r={},d=n("h1",{id:"创建项目",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#创建项目","aria-hidden":"true"},"#"),s(" 创建项目")],-1),k={class:"table-of-contents"},v=t(`<h2 id="_1-创建-nuxt3-项目" tabindex="-1"><a class="header-anchor" href="#_1-创建-nuxt3-项目" aria-hidden="true">#</a> 1. 创建 Nuxt3 项目</h2><p>本文全部使用 <code>pnpm</code> 作为包管理器，并全面使用 TypeScript。下面创建 Nuxt3 项目：</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token function">pnpm</span> dlx nuxi init twitter-clone
