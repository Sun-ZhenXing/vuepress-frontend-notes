...
`),n("span",{class:"token punctuation"},"}"),s(`
`)])])],-1),J=n("div",{class:"language-css","data-ext":"css"},[n("pre",{class:"language-css"},[n("code",null,[n("span",{class:"token selector"},".card"),s(),n("span",{class:"token punctuation"},"{"),s(`
...
`),n("span",{class:"token punctuation"},"}"),s(`
`)])])],-1),q=n("hr",{class:"footnotes-sep"},null,-1),D={class:"footnotes"},F={class:"footnotes-list"},G={id:"footnote1",class:"footnote-item"},H={href:"http://www.sass.hk",target:"_blank",rel:"noopener noreferrer"},K={href:"https://www.sass.hk/docs/",target:"_blank",rel:"noopener noreferrer"},M=n("a",{href:"#footnote-ref1",class:"footnote-backref"},"↩︎",-1);function O(P,Q){const o=i("router-link"),p=i("CodeTabs"),u=i("ExternalLinkIcon");return d(),k("div",null,[m,n("nav",h,[n("ul",null,[n("li",null,[e(o,{to:"#_1-sass-简介"},{default:a(()=>[s("1. Sass 简介")]),_:1})]),n("li",null,[e(o,{to:"#_2-语法特点"},{default:a(()=>[s("2. 语法特点")]),_:1}),n("ul",null,[n("li",null,[e(o,{to:"#_2-1-sass-和-scss"},{default:a(()=>[s("2.1 Sass 和 Scss")]),_:1})]),n("li",null,[e(o,{to:"#_2-2-使用变量"},{default:a(()=>[s("2.2 使用变量")]),_:1})]),n("li",null,[e(o,{to:"#_2-3-嵌套"},{default:a(()=>[s("2.3 嵌套")]),_:1})]),n("li",null,[e(o,{to:"#_2-4-混合"},{default:a(()=>[s("2.4 混合")]),_:1})]),n("li",null,[e(o,{to:"#_2-5-内置函数"},{default:a(()=>[s("2.5 内置函数")]),_:1})])])])])]),g,e(p,{id:"97",data:[{title:"Sass"},{title:"CSS"}]},{tab0:a(({title:t,value:c,isActive:l})=>[y]),tab1:a(({title:t,value:c,isActive:l})=>[_]),_:1}),f,S,e(p,{id:"111",data:[{title:"Sass"},{title:"CSS"}]},{tab0:a(({title:t,value:c,isActive:l})=>[x]),tab1:a(({title:t,value:c,isActive:l})=>[w]),_:1}),C,e(p,{id:"122",data:[{title:"Sass"},{title:"CSS"}]},{tab0:a(({title:t,value:c,isActive:l})=>[$]),tab1:a(({title:t,value:c,isActive:l})=>[A]),_:1}),z,e(p,{id:"133",data:[{title:"Sass"},{title:"CSS"}]},{tab0:a(({title:t,value:c,isActive:l})=>[N]),tab1:a(({title:t,value:c,isActive:l})=>[V]),_:1}),B,e(p,{id:"144",data:[{title:"Sass"},{title:"CSS"}]},{tab0:a(({title:t,value:c,isActive:l})=>[E]),tab1:a(({title:t,value:c,isActive:l})=>[I]),_:1}),T,j,e(p,{id:"158",data:[{title:"Sass"},{title:"CSS"}]},{tab0:a(({title:t,value:c,isActive:l})=>[L]),tab1:a(({title:t,value:c,isActive:l})=>[J]),_:1}),q,n("section",D,[n("ol",F,[n("li",G,[n("p",null,[s("Sass 中文文档，"),n("a",H,[s("www.sass.hk"),e(u)]),s("，"),n("a",K,[s("https://www.sass.hk/docs/"),e(u)]),s(),M])])])])])}const U=r(b,[["render",O],["__file","index.html.vue"]]);export{U as default};
