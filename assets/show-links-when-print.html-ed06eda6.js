...
<span class="token punctuation">}</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div>`,4);function m(_,h){const a=e("ExternalLinkIcon");return p(),o("div",null,[u,r,n("p",null,[s("为了测试，请使用浏览器的打印功能（可以按 "),d,s("，移动端可以使用菜单中的打印），这样 "),n("a",k,[s("这个链接"),c(a)]),s(" 的地址就会显示出来。")]),v])}const f=t(i,[["render",m],["__file","show-links-when-print.html.vue"]]);export{f as default};
