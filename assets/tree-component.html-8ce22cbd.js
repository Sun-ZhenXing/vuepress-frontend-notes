import{c as m,r as q,M as r,p,q as o,O as h,P as _,Q as n,w as f,v as y,Z as w,$ as N,N as l,R as x,_ as b,V as e,t as s,y as A,a1 as g}from"./framework-7cf43551.js";import"./font-awesome-4ed993c7.js";const T=["onClick"],C={key:1,class:"fa fa-file-o","aria-hidden":"true"},B={class:"name"},S={key:0,class:"sub-tree"},V=m({__name:"TreeTest",props:{items:null},setup(k){const d=k,c=q([]);return(u,v)=>{const i=r("tree-test",!0);return p(),o("ul",null,[(p(!0),o(h,null,_(d.items,(a,t)=>(p(),o("li",{key:a.name},[n("div",{class:"wrapper",onClick:J=>c.value[t]=!c.value[t]},[a.children&&a.children.length?(p(),o("i",{key:0,class:f(["fa",c.value[t]?"fa-angle-down":"fa-angle-right"]),"aria-hidden":"true"},null,2)):(p(),o("i",C)),n("span",B,y(a.name),1)],8,T),a.children&&a.children.length?(p(),o("div",S,[w(l(i,{items:a.children},null,8,["items"]),[[N,c.value[t]]])])):x("v-if",!0)]))),128))])}}});const $=b(V,[["__scopeId","data-v-a5514d6b"],["__file","TreeTest.vue"]]),j=[{name:"A",children:[{name:"A1",children:[{name:"A1.1"},{name:"A1.2"}]},{name:"A2"}]},{name:"B",children:[{name:"B1"},{name:"B2"}]},{name:"C"}],D=n("h1",{id:"vue-树形组件",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#vue-树形组件","aria-hidden":"true"},"#"),s(" Vue 树形组件")],-1),R={class:"table-of-contents"},L=n("h2",{id:"_1-实现原理",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_1-实现原理","aria-hidden":"true"},"#"),s(" 1. 实现原理")],-1),M=n("p",null,[s("本示例使用 "),n("code",null,"font-awesome"),s(" 作为图标库，如果你没有安装，可以使用下面的命令或 HTML 代码安装。")],-1),O=n("div",{class:"language-bash","data-ext":"sh"},[n("pre",{class:"language-bash"},[n("code",null,[n("span",{class:"token function"},"yarn"),s(),n("span",{class:"token function"},"add"),s(` font-awesome
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,6),I=m({__name:"tree-component.html",setup(k){return(d,c)=>{const u=r("router-link"),v=r("CodeTabs");return p(),o("div",null,[D,n("nav",R,[n("ul",null,[n("li",null,[l(u,{to:"#_1-实现原理"},{default:e(()=>[s("1. 实现原理")]),_:1})]),n("li",null,[l(u,{to:"#_2-示例"},{default:e(()=>[s("2. 示例")]),_:1})]),n("li",null,[l(u,{to:"#_3-递归修改名称"},{default:e(()=>[s("3. 递归修改名称")]),_:1})])])]),L,M,l(v,{id:"12",data:[{title:"yarn"},{title:"npm"},{title:"pnpm"},{title:"CDN"}]},{tab0:e(({title:i,value:a,isActive:t})=>[O]),tab1:e(({title:i,value:a,isActive:t})=>[P]),tab2:e(({title:i,value:a,isActive:t})=>[z]),tab3:e(({title:i,value:a,isActive:t})=>[E]),_:1}),F,l($,{items:A(j)},null,8,["items"]),H])}}}),G=b(I,[["__file","tree-component.html.vue"]]);export{G as default};
